      ...
      >
        <g transform="translate(50, -100)">
          <g transform="translate(-28.583 -435)">
            ...
            {/* --- ANIMATED CODE LINES ON LAPTOP --- */}
            <g id="code-lines-group">
              {[
                { w: 6.8, x: 557.7, y: 845.8 }, { w: 23.8, x: 567.9, y: 845.5 },
                { w: 6.8, x: 595, y: 845.8 }, { w: 6.8, x: 605.6, y: 845.8 },
                { w: 23.8, x: 617.5, y: 845.5 }, { w: 6.8, x: 567.7, y: 853.9 },
                { w: 23.8, x: 577.8, y: 853.6 }, { w: 23.8, x: 627.5, y: 853.6 },
                { w: 6.8, x: 577.6, y: 862 }, { w: 23.8, x: 587.7, y: 861.7 },
                { w: 6.8, x: 587.5, y: 870 }, { w: 23.8, x: 597.7, y: 869.8 }
              ].map((line, i) => (
                <motion.rect
                  key={i}
                  custom={i}
            ...
            {/* Animated Headline Placeholder on Main Monitor */}
            <motion.rect
              x="220" y="680" width="120" height="12" rx="6" fill="#6c63ff"
              animate={{ opacity: [0.3, 1, 0.3] }}
              transition={{ duration: 2, repeat: Infinity }}
            />
            <rect x="220" y="700" width="160" height="8" rx="4" fill="#e6e6e6" />
            <rect x="220" y="715" width="140" height="8" rx="4" fill="#e6e6e6" />
